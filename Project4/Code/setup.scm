...
(define (populate-weapons rooms)
  ...
  (create-weapon 'inflatable-lambda (pick-random rooms) 2)
  (create-weapon 'comp200-midterm (pick-random rooms) 2)
  (create-weapon 'stick-of-chalk (pick-random rooms) 1)
  (create-weapon 'potato (pick-random rooms) 3)
  (create-weapon 'apple (pick-random rooms) 2)
  (create-weapon 'tomato (pick-random rooms) 1)
  (create-weapon 'bottle (pick-random rooms) 3)
  (create-weapon 'plate (pick-random rooms) 2)
  (create-weapon 'spoon (pick-random rooms) 1)
  'populated-weapons)    	 		     
...
(define (populate-players rooms)
  ...
  (create-violent-person 'lambda-man (pick-random rooms)
			    3 3 2)
  (create-violent-person 'rector (pick-random rooms)
			    3 3 1)
  (create-violent-person 'guest (pick-random rooms)
			    3 3 2)
  (create-violent-person 'dean (pick-random rooms)
			    3 3 3)
